...
which \lstinline{anai} is a reference to the AE and \lstinline{cfgn} is a reference to the CFG node to be analysed. We send a reference to the AE to the monotone function so the user can have access to the
=======
...
>>>>>>> a20f737224a0425471591b2ee13c364a7658c9cc
...
<<<<<<< HEAD
   for n in cfgn.succs:
      club = anai.lub(club,anai.state(n))
=======
