...
from . import cfg_nodes as cfg_nodes
from cfg.cfg_nodes import CFGNode
from cfg.cfg_nodes import CFGNodeType
from cfg.cfg_nodes import CFGEntryNode
...
class CFGWCEC(object):
    ...
    def _gen_asm_file(self, cfile):
        abs_path = os.path.abspath(cfile)
        curdir = os.path.dirname(os.path.abspath(__file__))
        cpp_args = ['-g', '-S']
        path_list = ["cpp"] + cpp_args + [abs_path]
        text = []
